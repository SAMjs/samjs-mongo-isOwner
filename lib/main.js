      ...
      isOwner: function(options) {
        ...
        return this.addHook("afterCreate", function() {
          ...
          this.addHook("beforeFind", (function(_this) {
            return function(obj) {
              if (obj.socket.client.auth == null) {
                throw new Error("invalid socket - no auth");
              }
              if (samjs.auth.getAllowance(obj.socket.client.auth.user, _this.schema.path("owner").options.read, pc) !== "") {
          ...
          this.addHook("beforeInsert", function(obj) {
            ...
            if (this.plugins.users != null) {
              ...
              obj.query.owner = id;
              obj.query._id = id;
            } else if (samjs.auth.getAllowance(obj.socket.client.auth.user, this.schema.path("owner").options.read, pc) !== "") {
          ...
          this.addHook("beforeUpdate", (function(_this) {
            return function(obj) {
              if (samjs.auth.getAllowance(obj.socket.client.auth.user, _this.schema.path("owner").options.write, pc) !== "") {
          ...
          return this.addHook("beforeDelete", (function(_this) {
            return function(obj) {
              if (samjs.auth.getAllowance(obj.socket.client.auth.user, _this.schema.path("owner").options.write, pc) !== "") {
                obj.query.owner = obj.socket.client.auth.user[prop];
              }
